  ...
  let sessions = Object.entries(store)
    ...
    .map(([key, entry]) => {
      ...
      return {
        ...
        modelProvider,
        model,
        ...(entry?.modelSessions ? { modelSessions: { ...entry.modelSessions } } : {}),
        ...(entry?.cliSessionIds ? { cliSessionIds: { ...entry.cliSessionIds } } : {}),
        ...(entry?.claudeCliSessionId ? { claudeCliSessionId: entry.claudeCliSessionId } : {}),
